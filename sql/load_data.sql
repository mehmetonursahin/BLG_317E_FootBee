LOAD DATA INFILE './dataset/game_events.csv'
...
LOAD DATA INFILE './dataset/games.csv'
INTO TABLE games
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n' 
...
LOAD DATA INFILE './dataset/players.csv'
INTO TABLE players
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n' 
...
LOAD DATA INFILE './dataset/player_valuations.csv'
...
LOAD DATA INFILE './dataset/clubs.csv'
INTO TABLE clubs
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n' 
...
LOAD DATA INFILE './dataset/club_games.csv'
...
LOAD DATA INFILE './dataset/appearances.csv'
...
LOAD DATA INFILE './dataset/competitions.csv'
