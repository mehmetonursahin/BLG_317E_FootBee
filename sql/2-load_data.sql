...
LOAD DATA INFILE 'sql/dataset/clubs.csv'
INTO TABLE clubs
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n' 
...
LOAD DATA INFILE 'sql/dataset/games.csv'
INTO TABLE games
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n' 
...
LOAD DATA INFILE 'sql/dataset/players.csv'
INTO TABLE players
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\n' 
...
LOAD DATA INFILE 'sql/dataset/game_events.csv'
...
LOAD DATA INFILE 'sql/dataset/club_games.csv'
...
LOAD DATA INFILE 'sql/dataset/appearances.csv'
